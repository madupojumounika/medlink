      ...
      <div className="grid gap-6">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="bg-slate-900/50 backdrop-blur-sm border border-white/5 rounded-2xl p-6">
          <div className="flex items-center gap-3 mb-6 pb-4 border-b border-white/10">
            ...
            <h3 className="text-lg font-semibold text-white">Security & Passwords</h3>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="pt-6 border-t border-white/10 flex items-center justify-between">
              <div>
                <p className="text-white font-medium flex items-center gap-2"><Smartphone className="w-4 h-4 text-cyan-400"/> Two-Factor Authentication</p>
                <p className="text-sm text-slate-500">Add an extra layer of security to your account.</p>
              </div>
              <Button variant="outline" className="border-cyan-500/30 text-cyan-400 hover:bg-cyan-500/10">Enable 2FA</Button>
            </div>
          </div>
        </motion.div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 bg-slate-950/50 rounded-xl border border-white/5">
              <div>
                ...
                <p className="text-sm text-slate-500">Receive text messages for high priority referrals.</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
