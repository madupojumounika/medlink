...
const historyData = [
  { id: 'REF-801', patient: 'Michael Scott', to: 'City Clinic', severity: 'High', status: 'Completed', date: 'Oct 24, 2026' },
  { id: 'REF-802', patient: 'Jim Halpert', to: 'Northside Hospital', severity: 'Critical', status: 'Completed', date: 'Oct 23, 2026' },
  { id: 'REF-803', patient: 'Dwight Schrute', to: 'East Medical', severity: 'Medium', status: 'Declined', date: 'Oct 21, 2026' },
  { id: 'REF-804', patient: 'Pam Beesly', to: 'Central General', severity: 'Low', status: 'Completed', date: 'Oct 20, 2026' },
...
export default function ReferralHistory() {
  const columns = [
    ...
    { header: 'Final Status', accessorKey: 'status', cell: (row) => (
      <StatusBadge status={row.status === 'Completed' ? 'available' : 'critical'}>{row.status}</StatusBadge>
    )},
